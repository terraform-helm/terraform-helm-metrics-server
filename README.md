...
|------|-------------|------|---------|:--------:|
| <a name="input_chart"></a> [chart](#input\_chart) | Chart of helm release | `string` | `"metrics-server"` | no |
...
| <a name="input_name"></a> [name](#input\_name) | Name of helm release | `string` | `"metrics-server"` | no |
...
| <a name="input_repository"></a> [repository](#input\_repository) | Url of repository | `string` | `"https://kubernetes-sigs.github.io/metrics-server/"` | no |
